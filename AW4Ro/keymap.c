...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_voyager(
    KC_NO,          KC_NO,          NAVIGATOR_DEC_CPI,KC_NO,          NAVIGATOR_INC_CPI,DRAG_SCROLL,                                    KC_MS_BTN1,     KC_MS_BTN2,     KC_MS_BTN3,     KC_NO,          KC_NO,          KC_NO,          
    KC_NO,          KC_NO,          KC_NO,          KC_MS_DBL_CLICK,LSFT(KC_MS_BTN2),LSFT(KC_MS_BTN1),                                DRAG_SCROLL,    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_MS_ACCEL2,   
