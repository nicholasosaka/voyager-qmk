...
#define DUAL_FUNC_4 LT(6, KC_F18)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_voyager(
    KC_NO,          KC_NO,          NAVIGATOR_DEC_CPI,KC_NO,          NAVIGATOR_INC_CPI,DRAG_SCROLL,                                    DRAG_SCROLL,    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
